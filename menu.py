...
class Panel:
    def __init__(self, x: int, y: int, img: pygame.SurfaceType, buttons: list = None, width: int = None, height: int = None):
        # TODO: преобразование width и height в один square
        self.img = transform_img(img, square=max(width, height))
